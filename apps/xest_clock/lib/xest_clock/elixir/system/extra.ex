defmodule XestClock.System.Extra do
  ...
  def native_time_unit() do
    case System.convert_time_unit(1, :second, :native) do
  ...
  @doc """
    Normallizes time_unit, just like internal Elixir's System.normalize
  ...
  def time_unit_inf(a, b) do
    System.convert_time_unit(1, normalize_time_unit(b), normalize_time_unit(a)) == 0
  end
